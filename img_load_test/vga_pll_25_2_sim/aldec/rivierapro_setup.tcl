...
# ACDS 23.1 993 win32 2025.03.31.18:41:36
# ----------------------------------------
...
# ----------------------------------------
# If vga_pll_25_2 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "vga_pll_25_2"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vga_pll_25_2.vo"
}
