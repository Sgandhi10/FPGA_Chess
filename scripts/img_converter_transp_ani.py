...
if __name__ == "__main__":
    for file in os.listdir(r"C:\ECE4514\DD2_Final_PRJ\images\2-bit-transp"):
        if file.endswith(".png"):
            input_path = os.path.join(r"C:\ECE4514\DD2_Final_PRJ\images\2-bit-transp", file)
            output_path = os.path.join(r"C:\ECE4514\DD2_Final_PRJ\bitmaps\2-bit-transp", file.replace(".png", "2.mif"))
